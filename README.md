...
Além de promover uma visão mais ampla sobre as contratações governamentais, este projeto também teve como objetivo aprofundar meus conhecimentos em Análise de Dados, ETL, consumo de APIs e visualização de informações.
